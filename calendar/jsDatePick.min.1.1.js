g_arrayOfUsedJsDatePickCalsGlobalNumbers=new Array();g_currentDateObject=new Object();g_currentDateObject.dateObject=new Date();g_currentDateObject.day=g_currentDateObject.dateObject.getDate();g_currentDateObject.month=g_currentDateObject.dateObject.getMonth()+1;g_currentDateObject.year=g_currentDateObject.dateObject.getFullYear();$=function(id){
    ...
    var d=document;var JsDatePickBox=d.createElement("div");var clearfix=d.createElement("div");var closeButton=d.createElement("div");JsDatePickBox.setAttribute("group","JsDatePickBox");clearfix.setAttribute("group","clearfix");closeButton.setAttribute("group","jsDatePickCloseButton");closeButton.setAttribute("globalNumber",this.globalNumber);closeButton.onmouseover=function(){
        this.setAttribute("group","jsDatePickCloseButtonOver");var globalRef="gRef_"+this.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("Close the calendar");')
        };closeButton.onmouseout=function(){
        this.setAttribute("group","jsDatePickCloseButton");var globalRef="gRef_"+this.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("");')
        };closeButton.onmousedown=function(){
        this.setAttribute("group","jsDatePickCloseButtonDown");var globalRef="gRef_"+this.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("Close the calendar");')
        };closeButton.onmouseup=function(){
        this.setAttribute("group","jsDatePickCloseButton");var globalRef="gRef_"+this.getAttribute("globalNumber");eval("gRef_"+this.getAttribute("globalNumber")+".closeCalendar();");eval(globalRef+'.setTooltipText("");')
        };this.JsDatePickBox=JsDatePickBox;var leftWall=d.createElement("div");var rightWall=d.createElement("div");var topWall=d.createElement("div");var bottomWall=d.createElement("div");topWall.setAttribute("group","topWall");bottomWall.setAttribute("group","bottomWall");var topCorner=d.createElement("div");var bottomCorner=d.createElement("div");var wall=d.createElement("div");topCorner.setAttribute("group","leftTopCorner");bottomCorner.setAttribute("group","leftBottomCorner");wall.setAttribute("group","leftWall");this.leftWallStrechedElement=wall;this.leftWall=leftWall;this.rightWall=rightWall;leftWall.appendChild(topCorner);leftWall.appendChild(wall);leftWall.appendChild(bottomCorner);topCorner=d.createElement("div");bottomCorner=d.createElement("div");wall=d.createElement("div");topCorner.setAttribute("group","rightTopCorner");bottomCorner.setAttribute("group","rightBottomCorner");wall.setAttribute("group","rightWall");this.rightWallStrechedElement=wall;rightWall.appendChild(topCorner);rightWall.appendChild(wall);rightWall.appendChild(bottomCorner);if(this.oConfiguration.isStripped){
        leftWall.setAttribute("group","hiddenBoxLeftWall");rightWall.setAttribute("group","hiddenBoxRightWall")
        }else{
        leftWall.setAttribute("group","boxLeftWall");rightWall.setAttribute("group","boxRightWall")
    ...
    var i=0;var d=document;var weekDaysArray=new Array("Sun","Mon","Tue","Wed","Thu","Fri","Sat");var textNode;var weekDay;for(i=0;i<7;i++){
        weekDay=d.createElement("div");textNode=d.createTextNode(weekDaysArray[i]);weekDay.setAttribute("group","weekDay");if(weekDaysArray[i]=="Sat"){
    ...
    var d=document;var aDayDiv;var aTextNode;var columnNumber=1;var disabledDayFlag=false;var cmpMonth=this.currentMonth-1;var oDay=new Date(this.currentYear,cmpMonth,1,1,0,0);var iStamp=oDay.getTime();this.flag_DayMarkedBeforeRepopulation=false;this.setControlBarText(this.monthsTextualRepresentation[cmpMonth]+", "+this.currentYear);var skipDays=parseInt(oDay.getDay());var i=0;for(i=0;i<skipDays;i++){
        aDayDiv=d.createElement("div");aDayDiv.setAttribute("group","skipDay");aMainBox.appendChild(aDayDiv);if(columnNumber==7){
            columnNumber=1
            }else{
            columnNumber++
        }
        ...
        disabledDayFlag=false;aDayDiv=d.createElement("div");if(this.lastPostedDay){
            ...
            var globalRef="gRef_"+this.getAttribute("globalNumber");var currentColorScheme=eval(globalRef+".getCurrentColorScheme()");if(parseInt(this.getAttribute("isSelected"))==1){
                ...
                this.setAttribute("group","dayOverToday");this.style.background="url(img/"+currentColorScheme+"_dayOver.gif) left top no-repeat"
                }else{
                this.setAttribute("group","dayOver");this.style.background="url(img/"+currentColorScheme+"_dayOver.gif) left top no-repeat"
                }
            ...
            var globalRef="gRef_"+this.getAttribute("globalNumber");var currentColorScheme=eval(globalRef+".getCurrentColorScheme()");if(parseInt(this.getAttribute("isSelected"))==1){
                ...
                this.setAttribute("group","dayNormalToday");this.style.background="url(img/"+currentColorScheme+"_dayNormal.gif) left top no-repeat"
                }else{
                this.setAttribute("group","dayNormal");this.style.background="url(img/"+currentColorScheme+"_dayNormal.gif) left top no-repeat"
                }
            ...
            var globalRef="gRef_"+this.getAttribute("globalNumber");var currentColorScheme=eval(globalRef+".getCurrentColorScheme()");if(parseInt(this.getAttribute("isSelected"))==1){
                ...
                this.setAttribute("group","dayDownToday");this.style.background="url(img/"+currentColorScheme+"_dayDown.gif) left top no-repeat"
                }else{
                this.setAttribute("group","dayDown");this.style.background="url(img/"+currentColorScheme+"_dayDown.gif) left top no-repeat"
                }
            ...
            aDayDiv.setAttribute("isSelected",1);this.flag_DayMarkedBeforeRepopulation=true;this.lastMarkedDayObject=aDayDiv;if(parseInt(aDayDiv.getAttribute("isToday"))==1){
                aDayDiv.setAttribute("group","dayDownToday");aDayDiv.style.background="url(img/"+this.oConfiguration.cellColorScheme+"_dayDown.gif) left top no-repeat"
                }else{
                aDayDiv.setAttribute("group","dayDown");aDayDiv.style.background="url(img/"+this.oConfiguration.cellColorScheme+"_dayDown.gif) left top no-repeat"
                }
            }else{
            var globalRef="gRef_"+aDayDiv.getAttribute("globalNumber");var currentColorScheme=eval(globalRef+".getCurrentColorScheme()");if(parseInt(aDayDiv.getAttribute("isToday"))==1){
                if(disabledDayFlag){
                    aDayDiv.setAttribute("group","dayDisabled");aDayDiv.style.background="url(img/"+this.oConfiguration.cellColorScheme+"_dayNormal.gif) left top no-repeat"
                    }else{
                    aDayDiv.setAttribute("group","dayNormalToday");aDayDiv.style.background="url(img/"+this.oConfiguration.cellColorScheme+"_dayNormal.gif) left top no-repeat"
                    }
                }else{
                if(disabledDayFlag){
                    aDayDiv.setAttribute("group","dayDisabled");aDayDiv.style.background="url(img/"+this.oConfiguration.cellColorScheme+"_dayNormal.gif) left top no-repeat"
                    }else{
                    aDayDiv.setAttribute("group","dayNormal");aDayDiv.style.background="url(img/"+this.oConfiguration.cellColorScheme+"_dayNormal.gif) left top no-repeat"
                    }
                }
            }if(columnNumber==7){
            columnNumber=1
    ...
    var globalRef="gRef_"+anElement.getAttribute("globalNumber");var currentColorScheme=eval(globalRef+".getCurrentColorScheme()");if(this.flag_DayMarkedBeforeRepopulation){
        this.lastMarkedDayObject.setAttribute("isSelected",0);if(parseInt(this.lastMarkedDayObject.getAttribute("isToday"))==1){
            this.lastMarkedDayObject.setAttribute("group","dayNormalToday");this.lastMarkedDayObject.style.background="url(img/"+currentColorScheme+"_dayNormal.gif) left top no-repeat"
            }else{
            this.lastMarkedDayObject.setAttribute("group","dayNormal");this.lastMarkedDayObject.style.background="url(img/"+currentColorScheme+"_dayNormal.gif) left top no-repeat"
            }
        ...
        anElement.setAttribute("group","dayDownToday");anElement.style.background="url(img/"+currentColorScheme+"_dayDown.gif) left top no-repeat"
        }else{
        anElement.setAttribute("group","dayDown");anElement.style.background="url(img/"+currentColorScheme+"_dayDown.gif) left top no-repeat"
        }
    ...
    var d=document;var controlsBar=d.createElement("div");var monthForwardButton=d.createElement("div");var monthBackwardButton=d.createElement("div");var yearForwardButton=d.createElement("div");var yearBackwardButton=d.createElement("div");var controlsBarText=d.createElement("div");controlsBar.setAttribute("group","controlsBar");monthForwardButton.setAttribute("group","monthForwardButton");monthBackwardButton.setAttribute("group","monthBackwardButton");yearForwardButton.setAttribute("group","yearForwardButton");yearBackwardButton.setAttribute("group","yearBackwardButton");controlsBarText.setAttribute("group","controlsBarText");controlsBar.setAttribute("globalNumber",this.globalNumber);this.controlsBarTextCell=controlsBarText;controlsBar.appendChild(monthForwardButton);controlsBar.appendChild(monthBackwardButton);controlsBar.appendChild(yearForwardButton);controlsBar.appendChild(yearBackwardButton);controlsBar.appendChild(controlsBarText);monthForwardButton.onmouseover=function(){
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","monthForwardButtonOver");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
        ...
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","monthForwardButton");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
        ...
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","monthForwardButtonDown");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
            }var globalRef="gRef_"+parentElement.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("Move a month forward");')
        ...
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","monthBackwardButtonOver");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
        ...
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","monthBackwardButton");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
            }var globalRef="gRef_"+parentElement.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("");')
        };monthBackwardButton.onmousedown=function(){
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","monthBackwardButtonDown");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
            }var globalRef="gRef_"+parentElement.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("Move a month backward");')
        ...
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","yearForwardButtonOver");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
        ...
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","yearForwardButton");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
            }var globalRef="gRef_"+parentElement.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("");')
        };yearForwardButton.onmousedown=function(){
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","yearForwardButtonDown");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
            }var globalRef="gRef_"+parentElement.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("Move a year forward");')
        ...
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","yearBackwardButtonOver");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
        ...
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","yearBackwardButton");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
            }var globalRef="gRef_"+parentElement.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("");')
        };yearBackwardButton.onmousedown=function(){
        if(parseInt(this.getAttribute("isJsDatePickDisabled"))==1){
            return
        }this.setAttribute("group","yearBackwardButtonDown");var parentElement=this.parentNode;while(parentElement.groupName!="controlsBar"){
            parentElement=parentElement.parentNode
            }var globalRef="gRef_"+parentElement.getAttribute("globalNumber");eval(globalRef+'.setTooltipText("Move a year backward");')
